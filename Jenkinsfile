                ...
                parallel (
                    'docker login': {
                        withCredentials([string(credentialsId: 'dockerPass', variable: 'dockerPassword')]) {
                            sh "docker login -u deepankarthick -p ${dockerPassword}"
                        }
                    },
                    'ui-web-app-reactjs': {
                        dir('ui-web-app-reactjs'){
                            sh """
                            docker build -t deepankarthick/ui:v1 .
                            docker push deepankarthick/ui:v1
                            docker rmi deepankarthick/ui:v1
                            """
                        }
                    },
                    'zuul-api-gateway' : {
                        dir('zuul-api-gateway'){
                            sh """
                            docker build -t deepankarthick/api:v1 .
                            docker push deepankarthick/api:v1
                            docker rmi deepankarthick/api:v1
                            """
                        }
                    },
                    'offers-microservice-spring-boot': {
                        dir('offers-microservice-spring-boot'){
                            sh """
                            docker build -t deepankarthick/spring:v1 .
                            docker push deepankarthick/spring:v1
                            docker rmi deepankarthick/spring:v1
                            """
                        }
                    },
                    'shoes-microservice-spring-boot': {
                        dir('shoes-microservice-spring-boot'){
                            sh """
                            docker build -t deepankarthick/spring:v2 .
                            docker push deepankarthick/spring:v2
                            docker rmi deepankarthick/spring:v2
                            """
                        }
                    },
                    'cart-microservice-nodejs': {
                        dir('cart-microservice-nodejs'){
                            sh """
                            docker build -t deepankarthick/ui:v2 .
                            docker push deepankarthick/ui:v2
                            docker rmi deepankarthick/ui:v2
                            """
                        }
                    },
                    'wishlist-microservice-python': {
                        dir('wishlist-microservice-python'){
                            sh """
                            docker build -t deepankarthick/python:v1 .
                            docker push deepankarthick/python:v1
                            docker rmi deepankarthick/python:v1
                            """
                        }
                    }
                )
